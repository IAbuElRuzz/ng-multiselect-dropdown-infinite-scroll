...
import { NgMultiSelectDropDownInfiniteScrollModule } from '../src/ng-multiselect-dropdown-infinite-scroll.module';
...
export function createTestingModule<T>(cmp: Type<T>, template: string): ComponentFixture<T> {
    TestBed.configureTestingModule({
        imports: [FormsModule, NgMultiSelectDropDownInfiniteScrollModule],
        declarations: [cmp]
    })
